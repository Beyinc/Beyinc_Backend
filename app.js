...
// app.use(cors({ origin: ['http://localhost:3000', 'https://beyinc-frontend.vercel.app', 'https://yellow-mushroom-0aec0e610.2.azurestaticapps.net', 'https://www.bloomr.world','https://beyinc-frontend-dg45.vercel.app'] }));
// app.use(cors());
const corsOptions = {
  origin: [
    'http://localhost:3000',
...
// app.js
app.use(morgan("tiny"));
// Increased payload limits to support multiple base64 images sent in request bodies
...
app.use("/api/chatroom",verifyAccessToken, matchRouter);
